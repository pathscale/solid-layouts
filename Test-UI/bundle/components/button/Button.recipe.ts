...
_layouts:{slots:{"root":{base:"button",axes:{"variant":{"primary":"button--primary","secondary":"button--secondary","tertiary":"button--tertiary","outline":"button--outline","ghost":"button--ghost","danger":"button--danger","danger-soft":"button--danger-soft"},"size":{"xs":"button--xs","sm":"button--sm","md":"button--md","lg":"button--lg"},"justify":{"start":"button--justify-start","center":"button--justify-center","between":"button--justify-between"},"radius":{"none":"button--radius-none","sm":"button--radius-sm","md":"button--radius-md","full":"button--radius-full"},"isIconOnly":{"true":"button--icon-only"},"fillHeight":{"true":"button--fill-height"},"fullWidth":{"true":"button--full-width"},"isSelected":{"true":"button--selected"}}},"spinner":{base:"button__spinner",axes:{}},"startIcon":{base:"button__icon button__icon--start",axes:{}},"endIcon":{base:"button__icon button__icon--end",axes:{}}},stateKeys:[],slotIds:{"root":1,"spinner":2,"startIcon":3,"endIcon":0}}});
